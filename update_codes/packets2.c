...
//sign_mem *fst_ptr = (sign_mem*)malloc(sizeof(sign_mem));
//sign_mem *cur_ptr = (sign_mem*)malloc(sizeof(sign_mem));
//sign_mem *seach_ptr = (sign_mem*)malloc(sizeof(sign_mem));
...
///////////////////////////////////////////////////////////////////////////////////////////////
//bgp_encode_prefixes 署名生成してupdate messageに追加
///////////////////////////////////////////////////////////////////////////////////////////////
...
bgp_encode_prefixes(struct bgp_proto *p, byte *w, struct bgp_bucket *buck, uint remains)
{
  ...
  ip_addr a;
  int bytes;
  memcpy(w, "ski1-ski1-ski1-ski1ski2-ski2-ski2-ski2", 40);
  w += 40;
  ...
  while (!EMPTY_LIST(buck->prefixes) && (remains >= (5+sizeof(ip_addr)+100))){
      ...
      //リストからpxlenとprefixでsignを探索して取り出し
      seach_ptr = fst_ptr;
      while(1){
...
///////////////////////////////////////////////////////////////////////////////////////////////
//bgp_do_rx_update : decode the update message and verifty the sign. 
///////////////////////////////////////////////////////////////////////////////////////////////
